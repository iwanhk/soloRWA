package cc.bamboo.framework.web.core.util;

import cn.hutool.core.util.NumberUtil;
import cn.hutool.extra.servlet.ServletUtil;
import cc.bamboo.framework.common.enums.RpcConstants;
import cc.bamboo.framework.common.enums.TerminalEnum;
...
public class WebFrameworkUtils {
     ...
     * 终端的 Header
     *
     * @see cc.bamboo.framework.common.enums.TerminalEnum
     */
     ...
     * 获得当前请求的语言
     *
     * @return 语言 code，例如 zh-CN
     */
    public static String getCurrentLocale() {
        java.util.Locale locale = org.springframework.context.i18n.LocaleContextHolder.getLocale();
        // 返回 language-country 的格式，例如 zh-CN
        return locale.getLanguage()
                + (org.springframework.util.StringUtils.hasText(locale.getCountry()) ? "-" + locale.getCountry() : "");
    }
