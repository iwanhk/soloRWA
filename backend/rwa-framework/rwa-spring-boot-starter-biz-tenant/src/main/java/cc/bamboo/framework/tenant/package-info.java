 ...
 *      1）Spring Async：
 *          {@link cc.bamboo.framework.quartz.config.RwaAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 RwaSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cc.bamboo.framework.tenant;
