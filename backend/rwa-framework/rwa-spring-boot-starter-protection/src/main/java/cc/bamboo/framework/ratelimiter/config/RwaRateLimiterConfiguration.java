package cc.bamboo.framework.ratelimiter.config;

import cc.bamboo.framework.ratelimiter.core.aop.RateLimiterAspect;
import cc.bamboo.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import cc.bamboo.framework.ratelimiter.core.keyresolver.impl.*;
import cc.bamboo.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class RwaRateLimiterConfiguration {
