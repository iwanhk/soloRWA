package cc.bamboo.framework.tracer.config;

import cc.bamboo.framework.common.enums.WebFilterOrderEnum;
import cc.bamboo.framework.tracer.core.aop.BizTraceAspect;
import cc.bamboo.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "rwa.tracer", value = "enable", matchIfMissing = true)
public class RwaTracerAutoConfiguration {
