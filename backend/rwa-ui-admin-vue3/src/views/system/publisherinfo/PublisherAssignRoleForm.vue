...
import { PublisherInfoVO } from '@/api/system/publisherinfo'

defineOptions({ name: 'PublisherAssignRoleForm' })
...
/** 打开弹窗 */
const open = async (row: PublisherInfoVO) => {
  dialogVisible.value = true
  resetForm()
  // 设置数据
  formData.value.id = row.id
  formData.value.username = row.userPhone
