<template>
  <doc-alert title="SaaS 多发行商" url="https://doc.iocoder.cn/saas-tenant/" />
  ...
  <ContentWrap>
    <el-table v-loading="loading" :data="list" @selection-change="handleRowCheckboxChange">
      ...
      <el-table-column label="发行商编号" align="center" prop="id" />
      <el-table-column label="发行商名" align="center" prop="name" />
      <el-table-column label="发行商套餐" align="center" prop="packageId">
        <template #default="scope">
          <el-tag v-if="scope.row.packageId === 0" type="danger">系统发行商</el-tag>
...
<!--      <el-table-column label="绑定域名" align="center" prop="websites" width="180">
      ...
      <el-table-column label="发行商状态" align="center" prop="status">
        <template #default="scope">
      ...
      <el-table-column label="审核状态" align="center" prop="auditStatus" width="100">
        <template #default="scope">
          ...
          <el-tag v-else-if="scope.row.auditStatus === 3" type="danger">已拒绝</el-tag>
      ...
      <el-table-column label="操作" align="center" min-width="150" fixed="right">
        <template #default="scope">
          ...
          <el-button
            ...
            v-hasPermi="['system:tenant:audit']"
          >
            审核
          </el-button>
          <el-button
  ...
  <!-- 表单弹窗：查看 -->
  <TenantViewForm ref="viewFormRef" />
...
import TenantViewForm from './TenantViewForm.vue'
...
const packageList = ref([] as TenantPackageApi.TenantPackageVO[]) //发行商套餐列表
...
const openAuditDialog = (row: any) => {
  auditDialogRef.value.open(row.id, row.name)
}
