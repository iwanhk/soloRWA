        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="审核状态">
            <dict-tag
              ...
              v-if="formData.auditStatus !== undefined"
            />
          </el-descriptions-item>
          <el-descriptions-item label="2FA状态">
            <dict-tag
              :type="DICT_TYPE.F2A_STATUS"
              :value="formData.twoFactorAuthStatus"
              v-if="formData.twoFactorAuthStatus !== undefined"
            />
          </el-descriptions-item>
        </el-descriptions>
      </el-tab-pane>
      ...
      <el-tab-pane label="审核信息" name="audit">
        <el-table :data="auditList" border stripe>
          ...
          <el-table-column label="操作" align="center" width="100">
            <template #default="scope">
              <el-button link type="primary" @click="openAuditDetail(scope.row)"> 查看 </el-button>
            </template>
          </el-table-column>
        </el-table>
      </el-tab-pane>
