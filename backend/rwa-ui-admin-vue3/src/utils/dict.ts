...
export enum DICT_TYPE {
  ...
  BIZ_PROJECT_TYPE = 'biz_project_type', // 项目类型
  BIZ_ASSET_TYPE = 'biz_asset_type', // 资产类型
  BIZ_PROJECT_STATUS = 'biz_project_status', // 项目状态
  AGREEMENT_TYPE = 'agreement_type', // 系统协议类型
  BIZ_PROJECT_NOTICE_TYPE = 'biz_project_notice_type', // 项目通知类型
  BIZ_PROJECT_NOTICE_STATUS = 'biz_project_notice_status', // 项目通知状态
  BIZ_ORDER_STATUS = 'biz_order_status', // 订单状态
  BIZ_PAY_TYPE = 'biz_pay_type', // 支付方式
  BIZ_BILL_TYPE = 'biz_bill_type', // 账单类型
  BIZ_NOTICE_TYPE = 'biz_notice_type', // 消息模板类型
  BIZ_INCOME_STATUS = 'biz_income_status', // 订单收益状态
  F2A_STATUS = 'f2a_status', // 2FA 状态
  BIZ_USER_CHAIN_STATUS = 'biz_user_chain_status', // 用户链地址状态
  BIZ_COIN_TYPE = 'biz_coin_type',
  BIZ_LANGUAGE = 'biz_language',
  BIZ_PROJECT_CONFIG_TYPE = 'biz_project_config_type', // 项目配置类型
}
