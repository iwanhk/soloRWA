 ...
 * @param num
 */
export const formatToFraction = (num: number | string | undefined, precision: number = 2): string => {
  if (typeof num === 'undefined') return (0).toFixed(precision)
 ...
 * 分转元
 */
export const fenToYuan = (price: string | number, precision: number = 2): string => {
  return formatToFraction(price, precision)
}
