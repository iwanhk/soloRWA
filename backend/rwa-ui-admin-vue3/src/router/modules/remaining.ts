...
const remainingRouter: AppRouteRecordRaw[] = [
    ...
    },*/
  {
    ...
    children: [
      {
        path: 'info/create',
        component: () => import('@/views/project/projectinfo/ProjectCreate.vue'),
        name: 'ProjectCreate',
        meta: {
          canTo: true,
          hidden: true,
          ...
          icon: 'ep:plus',
          title: '创建项目',
          activeMenu: '/project/info'
        }
      },
      {
        path: 'info/space',
        component: () => import('@/views/project/projectinfo/ProjectSpace.vue'),
        name: 'ProjectSpace',
        meta: {
          canTo: true,
          hidden: true,
  ...
  },
  {
    ...
    children: [
      {
        path: 'submit-audit',
        component: () => import('@/views/tenant/submitAudit/index.vue'),
        name: 'TenantSubmitAudit',
        meta: {
          canTo: true,
          hidden: true,
          noTagsView: false,
