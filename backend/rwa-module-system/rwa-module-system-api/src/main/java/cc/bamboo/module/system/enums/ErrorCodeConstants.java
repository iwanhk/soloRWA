package cc.bamboo.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AUTH_LOGIN_BAD_CREDENTIALS = new ErrorCode(102000, "登录失败，账号密码不正确"); // 替代1_002_000_000
    ErrorCode AUTH_LOGIN_USER_DISABLED = new ErrorCode(102001, "登录失败，账号被禁用"); // 替代1_002_000_001
    ErrorCode AUTH_LOGIN_CAPTCHA_CODE_ERROR = new ErrorCode(102004, "验证码不正确，原因：{}"); // 替代1_002_000_004（保留原后两位编码，保持关联性）
    ErrorCode AUTH_THIRD_LOGIN_NOT_BIND = new ErrorCode(102005, "未绑定账号，需要进行绑定"); // 替代1_002_000_005
    ErrorCode AUTH_MOBILE_NOT_EXISTS = new ErrorCode(102007, "手机号不存在"); // 替代1_002_000_007
    ErrorCode AUTH_REGISTER_CAPTCHA_CODE_ERROR = new ErrorCode(102008, "验证码不正确，原因：{}"); // 替代1_002_000_008
    ErrorCode F2A_VERIFY_CODE_ERROR = new ErrorCode(102009, "2FA验证码不正确"); // 替代1_002_000_009
    ErrorCode F2A_NOT_INIT = new ErrorCode(102010, "2FA未初始化");
    // ========== 菜单模块 1-002-001-000 ==========
    ...
    ErrorCode Bank_ACCOUNT_NAME_NOT_MATCH = new ErrorCode(1_002_015_006, "银行账号名称与企业名称不匹配");
    ...
    // ========== 邮件验证码 1-002-025-100 ==========
    ErrorCode MAIL_CODE_NOT_FOUND = new ErrorCode(1_002_025_100, "邮箱验证码不存在或已过期");
    ErrorCode MAIL_CODE_SEND_TOO_FAST = new ErrorCode(1_002_025_101, "邮箱验证码发送过于频繁");
    ...
    // ========== 发行商 1-002-029-000 ==========
    ErrorCode PUBLISHER_INFO_NOT_EXISTS = new ErrorCode(1_002_029_000, "发行商不存在");
    ErrorCode PUBLISHER_PHONE_EXISTS = new ErrorCode(1_002_029_001, "手机号已被使用");
    ErrorCode PUBLISHER_COMPANY_CREDIT_CODE_EXISTS = new ErrorCode(1_002_029_002, "统一社会信用代码已存在");

    ErrorCode COMMON_CONFIG_NOT_EXISTS = new ErrorCode(999, "参数配置不存在");

    ErrorCode MAIL_CODE_INVALID = new ErrorCode(50204, "验证码错误");
}
