package cc.bamboo.module.system.controller.admin.sms.vo.template;

import cc.bamboo.framework.excel.core.annotations.DictFormat;
import cc.bamboo.framework.excel.core.convert.DictConvert;
import cc.bamboo.module.system.enums.DictTypeConstants;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "rwa")
    @ExcelProperty("模板名称")
    private String name;
