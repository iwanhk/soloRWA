...
import cc.bamboo.module.system.framework.sms.core.enums.SmsTemplateAuditStatusEnum;
import cc.bamboo.module.system.controller.admin.sms.vo.template.SmsTemplatePageReqVO;
import cc.bamboo.module.system.controller.admin.sms.vo.template.SmsTemplateSaveReqVO;
...
public class SmsTemplateServiceImpl implements SmsTemplateService {
    ...
    @Override
    @Cacheable(cacheNames = RedisKeyConstants.SMS_TEMPLATE, key = "#templateId",
            unless = "#result == null")
    public SmsTemplateDO getSmsTemplateByTemplateId(String templateId) {
