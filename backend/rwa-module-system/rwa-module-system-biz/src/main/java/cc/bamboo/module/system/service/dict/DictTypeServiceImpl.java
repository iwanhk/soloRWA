package cc.bamboo.module.system.service.dict;

import cn.hutool.core.util.StrUtil;
import cc.bamboo.framework.common.pojo.PageResult;
import cc.bamboo.framework.common.util.date.LocalDateTimeUtils;
import cc.bamboo.framework.common.util.object.BeanUtils;
import cc.bamboo.module.system.controller.admin.dict.vo.type.DictTypePageReqVO;
import cc.bamboo.module.system.controller.admin.dict.vo.type.DictTypeSaveReqVO;
import cc.bamboo.module.system.dal.dataobject.dict.DictTypeDO;
import cc.bamboo.module.system.dal.mysql.dict.DictTypeMapper;
...
public class DictTypeServiceImpl implements DictTypeService {
    ...
    @Override
    public List<DictTypeDO> getDictTypeListByMinId(Long minId) {
        return dictTypeMapper.selectListByMinId(minId);
    }
