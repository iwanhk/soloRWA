package cc.bamboo.module.system.service.social;
...
import cc.bamboo.framework.common.util.cache.CacheUtils;
import cc.bamboo.framework.common.util.http.HttpUtils;
import cc.bamboo.framework.common.util.object.BeanUtils;
import cc.bamboo.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import cc.bamboo.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import cc.bamboo.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import cc.bamboo.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import cc.bamboo.module.system.dal.dataobject.social.SocialClientDO;
import cc.bamboo.module.system.dal.mysql.social.SocialClientMapper;
import cc.bamboo.module.system.dal.redis.RedisKeyConstants;
import cc.bamboo.module.system.enums.social.SocialTypeEnum;
...
import static cc.bamboo.framework.common.util.collection.MapUtils.findAndThen;
import static cc.bamboo.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${rwa.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${rwa.wxa-subscribe-message.miniprogram-state:formal}")
