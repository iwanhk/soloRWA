package cc.bamboo.module.system.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * 字典类型及数据列表的缓存
     * <p>
     * KEY 格式：dict_type_with_data_list
     * VALUE 数据格式：String 字典类型及数据列表
     */
    String DICT_TYPE_WITH_DATA_LIST = "dict_type_with_data_list";
