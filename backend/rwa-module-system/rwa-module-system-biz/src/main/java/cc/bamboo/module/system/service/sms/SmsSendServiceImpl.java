package cc.bamboo.module.system.service.sms;

import cc.bamboo.module.system.dal.mysql.sms.SmsChannelMapper;
...
import cc.bamboo.module.system.framework.sms.core.client.SmsClient;
...
import cc.bamboo.module.system.dal.dataobject.sms.SmsChannelDO;
...
import cc.bamboo.module.system.mq.message.sms.SmsSendMessage;
import cc.bamboo.module.system.mq.producer.sms.SmsProducer;
...
public class SmsSendServiceImpl implements SmsSendService {
    ...
    public void doSendSms(SmsSendMessage message) {
        ...
        SmsChannelDO channel = smsChannelMapper.selectById(message.getChannelId());
        if(channel != null && ("YUNPIAN").equals(channel.getCode())){
            SmsTemplateDO template = smsTemplateService.getSmsTemplateByTemplateId(message.getApiTemplateId());
            if (template != null) {
                message.setApiTemplateId(template.getContent());
            }
        }
        // 发送短信
        try {
