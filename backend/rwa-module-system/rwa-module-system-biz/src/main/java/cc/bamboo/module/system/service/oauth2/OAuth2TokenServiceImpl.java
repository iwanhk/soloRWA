package cc.bamboo.module.system.service.oauth2;
...
import cc.bamboo.framework.common.exception.enums.GlobalErrorCodeConstants;
...
import cc.bamboo.module.system.controller.admin.oauth2.vo.token.OAuth2AccessTokenPageReqVO;
...
import cc.bamboo.module.system.dal.dataobject.oauth2.OAuth2RefreshTokenDO;
import cc.bamboo.module.system.dal.dataobject.user.AdminUserDO;
import cc.bamboo.module.system.dal.mysql.oauth2.OAuth2AccessTokenMapper;
import cc.bamboo.module.system.dal.mysql.oauth2.OAuth2RefreshTokenMapper;
import cc.bamboo.module.system.dal.redis.oauth2.OAuth2AccessTokenRedisDAO;
...
public class OAuth2TokenServiceImpl implements OAuth2TokenService {
    ...
    public OAuth2AccessTokenDO createAccessToken(Long userId, Integer userType, String clientId, List<String> scopes) {
        ...
        // 清理旧令牌，实现单点登录（踢人下线）
        List<OAuth2AccessTokenDO> accessTokenDOs = oauth2AccessTokenMapper.selectListByUserIdAndClient(userId, userType,
                clientId);
        if (CollUtil.isNotEmpty(accessTokenDOs)) {
            accessTokenDOs.forEach(accessTokenDO -> removeAccessToken(accessTokenDO.getAccessToken()));
        }
        // 创建刷新令牌
    ...
    /**
     * 加载用户信息，方便 {@link cc.bamboo.framework.security.core.LoginUser} 获取到昵称、部门等信息
     *
     * @param userId   用户编号
     * @param userType 用户类型
     * @return 用户信息
