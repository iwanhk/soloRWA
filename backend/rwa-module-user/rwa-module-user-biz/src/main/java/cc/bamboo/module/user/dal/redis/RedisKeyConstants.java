package cc.bamboo.module.user.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * 用户链签名数据的缓存
     * <p>
     * KEY 格式：user_chain_sign_data:{userId}:{chainAddress}
     * VALUE 数据格式：String 签名数据
     */
    String USER_CHAIN_SIGN_DATA = "user_chain_sign_data:%s:%s";

    /**
     * APP 协议列表的缓存
     * <p>
     * KEY 格式：app_agreement_list
     * VALUE 数据格式：String 协议列表 JSON
     */
    String APP_AGREEMENT_LIST = "app_agreement_list";

     /**
     * APP 协议详情的缓存
     * <p>
     * KEY 格式：app_agreement_detail:{id}
     * VALUE 数据格式：String 协议详情 JSON
     */
    String APP_AGREEMENT_DETAIL = "app_agreement_detail:%s";
