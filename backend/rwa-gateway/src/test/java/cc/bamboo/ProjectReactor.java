...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cc.bamboo";
    private static final String ARTIFACT_ID = "rwa";
    private static final String PACKAGE_NAME = "cc.bamboo";
    private static final String TITLE = "RWA管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cc.bamboo";
        String artifactIdNew = "rwa";
        String packageNameNew = "cc.bamboo";
        String titleNew = "RWA管理系统";
        String projectBaseDirNew = "D:\\java-work\\" + "rwa-bamboo-cloud"; // 一键改名后，“新”项目所在的目录
