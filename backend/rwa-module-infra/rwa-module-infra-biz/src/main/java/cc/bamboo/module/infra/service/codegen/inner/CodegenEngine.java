package cc.bamboo.module.infra.service.codegen.inner;
...
import cc.bamboo.framework.apilog.core.enums.OperateTypeEnum;
...
import cc.bamboo.framework.common.util.date.LocalDateTimeUtils;
import cc.bamboo.framework.common.util.object.BeanUtils;
import cc.bamboo.framework.common.util.object.ObjectUtils;
import cc.bamboo.framework.common.util.string.StrUtils;
...
import cc.bamboo.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "rwa-module-${table.moduleName}/" + // 顶级模块
                "rwa-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "rwa-module-${table.moduleName}/" + // 顶级模块
                "rwa-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "rwa-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "rwa-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
