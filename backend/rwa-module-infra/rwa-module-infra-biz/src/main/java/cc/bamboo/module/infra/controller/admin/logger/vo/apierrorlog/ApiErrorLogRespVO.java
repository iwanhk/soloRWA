package cc.bamboo.module.infra.controller.admin.logger.vo.apierrorlog;

import cc.bamboo.framework.excel.core.annotations.DictFormat;
import cc.bamboo.framework.excel.core.convert.DictConvert;
import cc.bamboo.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(cc.bamboo.module.system.enums.DictTypeConstants.USER_TYPE)
