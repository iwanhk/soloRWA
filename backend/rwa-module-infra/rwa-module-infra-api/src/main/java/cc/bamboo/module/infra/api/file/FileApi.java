package cc.bamboo.module.infra.api.file;

import cc.bamboo.framework.common.pojo.CommonResult;
import cc.bamboo.module.infra.api.file.dto.FileCreateReqDTO;
import cc.bamboo.module.infra.enums.ApiConstants;
...
public interface FileApi {
    ...
    default String createFile(String path, byte[] content) {
        return createFile(path, null, content);
    }
